...
const createIngredient = ingredient => `
    <li class="recipe__item">
        ...
        <div class="recipe__count">${countFraction(ingredient.count)}</div>
...
`;
domElements.recipeDetails.insertAdjacentHTML('afterbegin', recipeMarkup)
}
...
export const updateServingIngredients = recipe => {
    ...
    ingCount.forEach((el, i) =>{
        el.textContent  =   countFraction(recipe.ingredients[i].count)
    })
}